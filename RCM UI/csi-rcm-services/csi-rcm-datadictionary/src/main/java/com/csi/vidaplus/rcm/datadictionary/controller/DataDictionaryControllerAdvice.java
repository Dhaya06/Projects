...
/**
 * This class all the run time exceptions related to DataDictionaryController
 * 
 * @version 1.0 12 Jan 2018
 * @author Firstname Lastname
 */
@ControllerAdvice(basePackageClasses = DataDictionaryController.class)
@RequestMapping(produces = "application/json")
public class DataDictionaryControllerAdvice extends ResponseEntityExceptionHandler {

	/**
	 * This handle the constraint violation exception
	 * 
	 * @param ex
	 *            exception
	 * @param request
	...
	protected ResponseEntity<ResponseEnvelope> handleUncheckedException(Exception ex, WebRequest request) {
		String error = "Data Dictionary Exception occurred";
		ResponseEnvelope responseEnvelope = new ResponseEnvelope(HttpStatus.INTERNAL_SERVER_ERROR,
