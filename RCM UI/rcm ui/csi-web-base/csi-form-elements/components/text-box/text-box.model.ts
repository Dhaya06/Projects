...
export const ComponentId = FormElementRegistry.text;

export interface CsiTextInput {
    ...
    maxLength?: number;
    minLength?: number;
    events?: CsiTextInputEvents,
}

export interface CsiTextInputEvents {
    blur?: any;
    keyup?: any;
    keypress?: any;
    keydown?: any;
...
export const EmptyCsiTextInputModel:CsiTextInput = {
...
export function getTextComponenetFromEmptyModel(data: CsiTextInput): CsiTextInput{
    return {
        componentId:ComponentId,
        id : data.name,
        name : data.name,
