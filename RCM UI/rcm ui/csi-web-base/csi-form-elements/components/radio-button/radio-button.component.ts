import { CsiRadioButtonInput, ComponentId } from './radio-button.model';
...
@ComponentRegistry({
  ...
  service: RadioButtonService
})

export class RadioButtonComponent extends CsiBaseComponent implements OnInit, ControlValueAccessor {
  // Input variables
