import { Component, OnInit, Input, ElementRef, Renderer, Injector, ChangeDetectionStrategy, ChangeDetectorRef, HostListener, EventEmitter, Output, SimpleChanges } from '@angular/core';
...
import { CsiPasswordInput, ComponentId } from './password-box.model';
import { PasswordBoxService } from './password-box.service';
import { ComponentRegistry, CsiBaseComponent } from 'csi-base';

@Component({
  selector: 'csi-password-box',
  templateUrl: './password-box.component.html',
  styleUrls: ['./password-box.component.css'],
  providers: [
    {provide: NG_VALUE_ACCESSOR, useExisting: PasswordBoxComponent, multi: true}
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
@ComponentRegistry({
  componentId: ComponentId,
  service: PasswordBoxService
})
export class PasswordBoxComponent  extends CsiBaseComponent implements OnInit, ControlValueAccessor {
