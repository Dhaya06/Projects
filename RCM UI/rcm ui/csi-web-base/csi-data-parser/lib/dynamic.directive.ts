...
@Directive({
  selector: '[csiDynamicInputs],[csiDynamicOutputs],[ngComponentOutletCsiDynamicInputs],[ngComponentOutletCsiDynamicOutputs]'
})
export class DynamicDirective implements OnChanges, DoCheck, OnDestroy {

  @Input() csiDynamicInputs: { [k: string]: any };
  @Input() ngComponentOutletCsiDynamicInputs: { [k: string]: any };
  @Input() csiDynamicOutputs: { [k: string]: Function };
  @Input() ngComponentOutletCsiDynamicOutputs: { [k: string]: Function };
  ...
  private get _inputs() {
    return this.csiDynamicInputs || this.ngComponentOutletCsiDynamicInputs;
  }

  private get _outputs() {
    return this.csiDynamicOutputs || this.ngComponentOutletCsiDynamicOutputs;
  }
